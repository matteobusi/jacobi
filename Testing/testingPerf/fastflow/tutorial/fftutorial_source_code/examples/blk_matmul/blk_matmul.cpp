...
int main(int argc, char* argv[]) {     
    ...
    if (check) {
        ...
        get_time_and_check(blockMMult, b, M, N, P, A, P, B, N, C, C2, "Block-based MM");
        free(C2);
    } else 
        get_time(blockMMult, b, M, N, P, A, P, B, N, C, "Block-based MM");
